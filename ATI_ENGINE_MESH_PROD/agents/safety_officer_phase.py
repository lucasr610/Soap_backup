#!/usr/bin/env python3
"""safety_officer_phase.py
Safety conscience for the ATI SOP system.
...
LOG_FILE = LOG_DIR / "safety_officer_phase.log"
...
def run_safety_officer():
    """Compatibility wrapper for the renamed agent."""
    run_mother()
